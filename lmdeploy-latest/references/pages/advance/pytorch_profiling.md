# PyTorchEngine Profiling — lmdeploy

Source: https://lmdeploy.readthedocs.io/en/latest/advance/pytorch_profiling.html
...
For single-GPU scenarios, simply use `nsysprofile`:
