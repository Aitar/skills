# How to debug Turbomind — lmdeploy

Source: https://lmdeploy.readthedocs.io/en/latest/advance/debug_turbomind.html
...
If it shows `Readingsymbolsfrompython3`, the configuration has been successful.
