# Context Parallel — lmdeploy

Source: https://lmdeploy.readthedocs.io/en/latest/advance/context_parallel.html
...
The amount of available kv_cache is halved, which reducing the maximum supported session length.

The maximum inference batch size is reduced, leading to lower throughput.
