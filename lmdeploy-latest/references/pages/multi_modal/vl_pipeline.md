# Offline Inference Pipeline — lmdeploy

Source: https://lmdeploy.readthedocs.io/en/latest/multi_modal/vl_pipeline.html
...
This article showcases the VLM pipeline using the OpenGVLab/InternVL2_5-8B model as a case study.
