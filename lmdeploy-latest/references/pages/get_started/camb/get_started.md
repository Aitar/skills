...
Source: https://lmdeploy.readthedocs.io/en/latest/get_started/camb/get_started.html
...
`dockerpullcrpi-4crprmm5baj1v8iv.cn-hangzhou.personal.cr.aliyuncs.com/lmdeploy_dlinfer/camb:latest`
...
Add `--devicecamb` in the serve command.
