...
Source: https://docs.vllm.ai/en/v0.15.0/features/nixl_connector_usage/
...
recompute (default): Recompute failed blocks locally on the decode instance. This may cause performance jitter on decode instances as the scheduled prefill will delay and interfere with other decodes. Furthermore, decode instances are typically configured with low-latency optimizations.
