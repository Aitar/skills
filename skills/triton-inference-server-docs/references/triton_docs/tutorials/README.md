...
# Triton Tutorials[#](#triton-tutorials "Link to this heading")

For users experiencing the âTensor inâ & âTensor outâ approach to Deep Learning Inference, getting started with Triton can lead to many questions. The goal of this repository is to familiarize users with Tritonâs features and provide guides and examples to ease migration. For a feature by feature explanation, refer to the [Triton Inference Server documentation](https://docs.nvidia.com/deeplearning/triton-inference-server/user-guide/docs/index.md).

## Getting Started Checklist[#](#getting-started-checklist "Link to this heading")
...
## Quick Deploy[#](#quick-deploy "Link to this heading")
...
### Deploy a â¦[#](#deploy-a "Link to this heading")
...
## LLM Tutorials[#](#llm-tutorials "Link to this heading")
...
## What does this repository contain?[#](#what-does-this-repository-contain "Link to this heading")

This repository contains the following resources:

* [Conceptual Guide](https://github.com/triton-inference-server/tutorials/blob/main/Conceptual_Guide): This guide focuses on building a conceptual understanding of the general challenges faced whilst building inference infrastructure and how to best tackle these challenges with Triton Inference Server.
...
* [HuggingFace Guide](https://github.com/triton-inference-server/tutorials/blob/main/HuggingFace): The focus of this guide is to walk the user through different methods in which a HuggingFace model can be deployed using the Triton Inference Server.
* [Feature Guides](https://github.com/triton-inference-server/tutorials/blob/main/Feature_Guide): This folder is meant to house Tritonâs feature-specific examples.
...
* [Agentic Workflow Guide](https://github.com/triton-inference-server/tutorials/blob/main/AI_Agents_Guide): This guide provides a set of tutorials designed to help you deploy AI agents efficiently using the Triton Inference Server.

## Navigating Triton Inference Server Resources[#](#navigating-triton-inference-server-resources "Link to this heading")
...
* [Backend](https://github.com/triton-inference-server/backend) contains the core scripts and utilities to build a new Triton Backend. Any repository containing the word âbackendâ is either a framework backend or an example for how to create a backend.
...
## Adding Requests[#](#adding-requests "Link to this heading")
