* [Model Pipelines](../server_guide/model_pipelines.md)
* Ensemble Models
...
## Managing Memory Usage in Ensemble Models[#](#managing-memory-usage-in-ensemble-models "Link to this heading")
...
### When to Use This Feature[#](#when-to-use-this-feature "Link to this heading")
...
### Choosing the Right Value[#](#choosing-the-right-value "Link to this heading")
...
* **Minimal overhead when enabled**: Uses a blocking/wakeup mechanism per ensemble step, where upstream models are paused (âblockedâ) when the inflight requests limit is reached and resumed (âwoken upâ) as downstream models complete processing them. This synchronization ensures memory usage stays within bounds, though it may increase latency.
