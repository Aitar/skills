# Guided Decoding — TensorRT LLM

Source: https://nvidia.github.io/TensorRT-LLM/1.3.0rc7/features/guided-decoding.html
...
XGrammar: Supports JSON schema, regular expression, EBNF and structural tag.

LLGuidance: Supports JSON schema, regular expression, EBNF.
