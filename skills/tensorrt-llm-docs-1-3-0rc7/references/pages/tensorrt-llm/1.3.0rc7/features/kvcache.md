...
Source: https://nvidia.github.io/TensorRT-LLM/1.3.0rc7/features/kvcache.html
...
See this example for an example of how to change block priorities of specific requests by altering their retention policy.

Speculative Decoding#

Reuse across requests is supported by all speculative decoding models. Please see speculative decoding for more details.
...
Many of the features in the KV cache system are optional or have user defined properties that alter how they work. Users can control KV cache features through class KVCacheConfig. The remainder of this section describes how to change the most important behaviors of the KV cache system.

See this example for an example of how to use KvCacheConfig to control KV cache behavior.
...
Here is an example to show how to enable host offloading.
