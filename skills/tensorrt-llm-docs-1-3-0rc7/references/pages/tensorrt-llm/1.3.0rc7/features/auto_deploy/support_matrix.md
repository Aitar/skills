...
Source: https://nvidia.github.io/TensorRT-LLM/1.3.0rc7/features/auto_deploy/support_matrix.html
...
| `flashinfer` | Uses optimized attention kernels with KV Cache from the `flashinfer` library. |
