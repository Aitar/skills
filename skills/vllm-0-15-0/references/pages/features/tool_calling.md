...
Source: https://docs.vllm.ai/en/v0.15.0/features/tool_calling/
...
The model can generate parameters in an incorrect format, such as generating an array serialized as string instead of an array.

VLLM provides two JSON-based chat templates for Llama 3.1 and 3.2:

examples/tool_chat_template_llama3.1_json.jinja - this is the "official" chat template for the Llama 3.1 models, but tweaked so that it works better with vLLM.

examples/tool_chat_template_llama3.2_json.jinja - this extends upon the Llama 3.1 chat template by adding support for images.
...
examples/tool_chat_template_llama4_pythonic.jinja - this is based on the official chat template for the Llama 4 models.
...
`MiniMaxAi/MiniMax-M1-40k` (use with examples/tool_chat_template_minimax_m1.jinja)

`MiniMaxAi/MiniMax-M1-80k` (use with examples/tool_chat_template_minimax_m1.jinja)
...
`deepseek-ai/DeepSeek-V3-0324` (use with examples/tool_chat_template_deepseekv3.jinja)

`deepseek-ai/DeepSeek-R1-0528` (use with examples/tool_chat_template_deepseekr1.jinja)
...
`deepseek-ai/DeepSeek-V3.1` (use with examples/tool_chat_template_deepseekv31.jinja)
...
`meta-llama/Llama-3.2-1B-Instruct` ⚠️ (use with examples/tool_chat_template_llama3.2_pythonic.jinja)

`meta-llama/Llama-3.2-3B-Instruct` ⚠️ (use with examples/tool_chat_template_llama3.2_pythonic.jinja)
...
`meta-llama/Llama-4-Scout-17B-16E-Instruct` ⚠️ (use with examples/tool_chat_template_llama4_pythonic.jinja)

`meta-llama/Llama-4-Maverick-17B-128E-Instruct` ⚠️ (use with examples/tool_chat_template_llama4_pythonic.jinja)
