Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/examples/kvcacheretentionconfig.md

* How to Change Block Priorities

# How to Change Block Priorities[#](#how-to-change-block-priorities "Link to this heading")
