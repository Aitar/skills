Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/examples/llm_multilora.md

* [LLM Examples](llm_api_examples.md)
* Generate text with multiple LoRA adapters

# Generate text with multiple LoRA adapters[#](#generate-text-with-multiple-lora-adapters "Link to this heading")

Source [NVIDIA/TensorRT-LLM](https://github.com/NVIDIA/TensorRT-LLM/blob/48b7b5d8b7ed1e6bff57aecc6ff7d1533288bed8/examples/llm-api/llm_multilora.py).
...
Control generated text using logits processor](llm_logits_processor.md "previous page")
[next

Speculative Decoding](llm_speculative_decoding.md "next page")