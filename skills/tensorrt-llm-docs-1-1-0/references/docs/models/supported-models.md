Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/models/supported-models.md
...
## Model-Feature Support Matrix(Key Models)[#](#model-feature-support-matrix-key-models "Link to this heading")
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DeepseekV3ForCausalLM | Yes | Yes | Yes | Yes | Yes [[1]](#id3) | Yes | No | No | Yes | Yes | Yes [[2]](#id4) | N/A | Yes | Yes |
...
# Multimodal Feature Support Matrix (PyTorch Backend)[#](#multimodal-feature-support-matrix-pytorch-backend "Link to this heading")
...
| NemotronH\_Nano\_VL\_V2 | Yes | Yes | Yes | Yes | Yes | N/A | Yes | No | L + I + V |
...
| Qwen2\_5\_VLForConditionalGeneration | Yes | Yes | Yes | Yes | Yes | Yes | Yes | No | L + I + V |
...
Quick Start Recipe for GPT-OSS on TensorRT-LLM - Blackwell Hardware](../deployment-guide/quick-start-recipe-for-gpt-oss-on-trtllm.md "previous page")
[next

Adding a New Model](adding-new-model.md "next page")

On this page

* [Supported Models](#)
  + [Model-Feature Support Matrix(Key Models)](#model-feature-support-matrix-key-models)
* [Multimodal Feature Support Matrix (PyTorch Backend)](#multimodal-feature-support-matrix-pytorch-backend)