Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/_modules/tensorrt_llm/executor/result.md

* [Module code](../../index.md)
* tensorrt\_llm.executor.result

# Source code for tensorrt\_llm.executor.result
