Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/_modules/tensorrt_llm/llmapi/build_cache.md

* [Module code](../../index.md)
* tensorrt\_llm.llmapi.build\_cache

# Source code for tensorrt\_llm.llmapi.build\_cache
