Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/_modules/tensorrt_llm/models/gpt/config.md

* [Module code](../../../index.md)
* tensorrt\_llm.models.gpt.config

# Source code for tensorrt\_llm.models.gpt.config
