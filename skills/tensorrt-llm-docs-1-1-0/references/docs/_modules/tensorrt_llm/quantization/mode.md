Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/_modules/tensorrt_llm/quantization/mode.md

* [Module code](../../index.md)
* tensorrt\_llm.quantization.mode

# Source code for tensorrt\_llm.quantization.mode
