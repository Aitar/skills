Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/blogs/H200launch.md
...
# H200 achieves nearly 12,000 tokens/sec on Llama2-13B with TensorRT LLM[#](#h200-achieves-nearly-12-000-tokens-sec-on-llama2-13b-with-tensorrt-llm "Link to this heading")
...
| Model | Batch Size(1) | TP(2) | Input Length | Output Length | Throughput (out tok/s/GPU) |
| --- | --- | --- | --- | --- | --- |
| llama\_13b | 1024 | 1 | 128 | 128 | 11,819 |
| llama\_13b | 128 | 1 | 128 | 2048 | 4,750 |
| llama\_13b | 64 | 1 | 2048 | 128 | 1,349 |
| llama\_70b | 512 | 1 | 128 | 128 | 3,014 |
| llama\_70b | 512 | 2 | 128 | 2048 | 1,654 |
| llama\_70b | 64 | 1 | 2048 | 128 | 341 |
| llama\_70b | 32 | 1 | 2048 | 128 | 303 |
...
Additional Performance data is available on the [NVIDIA Data Center Deep Learning Product Performance](https://developer.nvidia.com/deep-learning-performance-training-inference/ai-inference) page, & soon in [TensorRT LLM’s Performance Documentation](https://nvidia.github.io/TensorRT-LLM/0.21.0/performance/perf-overview.md).

## H200 vs H100[#](#h200-vs-h100 "Link to this heading")
...
![H200 TPS](https://github.com/NVIDIA/TensorRT-LLM/blob/rel/docs/source/blogs/media/H200launch_tps.png?raw=true)
...
![max throughput llama sweep](https://github.com/NVIDIA/TensorRT-LLM/blob/rel/docs/source/blogs/media/H200launch_H200vsH100_tps.png?raw=true)
...
## Latest HBM Memory[#](#latest-hbm-memory "Link to this heading")
...
How to get best performance on DeepSeek-R1 in TensorRT LLM](Best_perf_practice_on_DeepSeek-R1_in_TensorRT-LLM.md "previous page")
[next

New XQA-kernel provides 2.4x more Llama-70B throughput within the same latency budget](XQA-kernel.md "next page")

On this page

* [H200 vs H100](#h200-vs-h100)
* [Latest HBM Memory](#latest-hbm-memory)