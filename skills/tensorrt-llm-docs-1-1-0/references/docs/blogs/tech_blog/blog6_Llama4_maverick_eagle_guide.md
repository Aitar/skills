Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/blogs/tech_blog/blog6_Llama4_maverick_eagle_guide.md

* How to launch Llama4 Maverick + Eagle3 TensorRT LLM server

# How to launch Llama4 Maverick + Eagle3 TensorRT LLM server[#](#how-to-launch-llama4-maverick-eagle3-tensorrt-llm-server "Link to this heading")
...
## Download Artifacts[#](#download-artifacts "Link to this heading")
...
### Step 1: Clone the repository[#](#step-1-clone-the-repository "Link to this heading")
...
### Step 2: Prepare the TensorRT LLM release Docker image[#](#step-2-prepare-the-tensorrt-llm-release-docker-image "Link to this heading")

#### Option 1. Use weekly release NGC docker image[#](#option-1-use-weekly-release-ngc-docker-image "Link to this heading")
...
#### Option 2. Build TensorRT LLM Docker image (Alternative way)[#](#option-2-build-tensorrt-llm-docker-image-alternative-way "Link to this heading")
...
### Step 3: (Optional) Tag and push the Docker image to your registry[#](#step-3-optional-tag-and-push-the-docker-image-to-your-registry "Link to this heading")
...
### Step 4: Start the TensorRT LLM server[#](#step-4-start-the-tensorrt-llm-server "Link to this heading")
...
### Step 5: Test the server with a sample request[#](#step-5-test-the-server-with-a-sample-request "Link to this heading")
...
### Step 6: (Optional) Monitor server logs[#](#step-6-optional-monitor-server-logs "Link to this heading")
...
### Step 7: (Optional) Stop the server[#](#step-7-optional-stop-the-server "Link to this heading")
...
Disaggregated Serving in TensorRT LLM](blog5_Disaggregated_Serving_in_TensorRT-LLM.md "previous page")
[next

N-Gram Speculative Decoding in TensorRT LLM](blog7_NGram_performance_Analysis_And_Auto_Enablement.md "next page")
...
* [Launching the server](#launching-the-server)
  ...
  + [Step 2: Prepare the TensorRT LLM release Docker image](#step-2-prepare-the-tensorrt-llm-release-docker-image)
    - [Option 1. Use weekly release NGC docker image](#option-1-use-weekly-release-ngc-docker-image)
    - [Option 2. Build TensorRT LLM Docker image (Alternative way)](#option-2-build-tensorrt-llm-docker-image-alternative-way)
  + [Step 3: (Optional) Tag and push the Docker image to your registry](#step-3-optional-tag-and-push-the-docker-image-to-your-registry)
  + [Step 4: Start the TensorRT LLM server](#step-4-start-the-tensorrt-llm-server)
  + [Step 5: Test the server with a sample request](#step-5-test-the-server-with-a-sample-request)
  + [Step 6: (Optional) Monitor server logs](#step-6-optional-monitor-server-logs)
  + [Step 7: (Optional) Stop the server](#step-7-optional-stop-the-server)
