Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/blogs/tech_blog/blog12_Combining_Guided_Decoding_and_Speculative_Decoding.md

* Combining Guided Decoding and Speculative Decoding: Making CPU and GPU Cooperate Seamlessly

# Combining Guided Decoding and Speculative Decoding: Making CPU and GPU Cooperate Seamlessly[#](#combining-guided-decoding-and-speculative-decoding-making-cpu-and-gpu-cooperate-seamlessly "Link to this heading")
...
## Background and Challenges[#](#background-and-challenges "Link to this heading")
...
### Guided Decoding[#](#guided-decoding "Link to this heading")
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog12_constrained_decoding_pipeline_overlap.png)
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog12_one_model_vs_two_model.png)

*Figure 2: Top: GPU timeline of one-model speculative decoding. Bottom: GPU timeline of two-model speculative decoding.*

### Two Challenges[#](#two-challenges "Link to this heading")
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog12_cpu_gpu_synchronization_for_multiple_steps.png)
...
## Trace Grammar State for Draft Token Proposal and Rejection[#](#trace-grammar-state-for-draft-token-proposal-and-rejection "Link to this heading")

### Target Model[#](#target-model "Link to this heading")
...
### Draft Model[#](#draft-model "Link to this heading")
...
## Make Grammar Computation Capturable by CUDA Graph[#](#make-grammar-computation-capturable-by-cuda-graph "Link to this heading")

### CUDA Callback[#](#cuda-callback "Link to this heading")
...
CUDA callback [`cudaLaunchHostFunc`](https://docs.nvidia.com/cuda/cuda-runtime-api/group__CUDART__EXECUTION.md#group__CUDART__EXECUTION_1g05841eaa5f90f27124241baafb3e856f) can launch a host function to a CUDA stream. (The host function should not call any CUDA API.) This has two crucial implications:
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog12_cpu_gpu_synchronization_for_multiple_steps_by_cuda_callback.png)

*Figure 4: The CPU-GPU synchronization for multiple model forwards by CUDA callback.*

### Integration to TensorRT LLM Python Runtime[#](#integration-to-tensorrt-llm-python-runtime "Link to this heading")
...
### CUDA Graph Compatibility: Grammar Computation[#](#cuda-graph-compatibility-grammar-computation "Link to this heading")
...
### CUDA Graph Compatibility: Mask Applying Kernel[#](#cuda-graph-compatibility-mask-applying-kernel "Link to this heading")
...
### Troubleshooting: Data Race between Host and CUDA Callback[#](#troubleshooting-data-race-between-host-and-cuda-callback "Link to this heading")
...
### Troubleshooting: Deadlock by GIL and CUDA Mutex[#](#troubleshooting-deadlock-by-gil-and-cuda-mutex "Link to this heading")
...
## Performance and Analysis[#](#performance-and-analysis "Link to this heading")
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog12_pareto_curve_json_mode_eval_llama_3.1_8b.png)

*Figure 5: Pareto curve on LLaMA 3.1 8B TP1 on H200, JSON Mode Eval. The concurrency ranges from 1 to 128.*

![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog12_pareto_curve_json_mode_eval_llama_3.3_70b.png)
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog12_pareto_curve_json_schema_bench_llama_3.1_8b.png)

*Figure 7: Pareto curve on LLaMA 3.1 8B TP1 on H200, JSON Schema Bench. The concurrency ranges from 1 to 128.*

![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog12_pareto_curve_json_schema_bench_llama_3.3_70b.png)
...
Running GPT-OSS-120B with Eagle3 Speculative Decoding on GB200/B200 (TensorRT LLM)](blog11_GPT_OSS_Eagle3.md "previous page")
[next

Inference Time Compute Implementation in TensorRT LLM](blog13_Inference_Time_Compute_Implementation_in_TensorRT-LLM.md "next page")
