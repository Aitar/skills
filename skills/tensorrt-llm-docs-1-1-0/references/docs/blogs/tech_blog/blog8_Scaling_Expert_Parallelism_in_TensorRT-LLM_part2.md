Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/blogs/tech_blog/blog8_Scaling_Expert_Parallelism_in_TensorRT-LLM_part2.md

* Scaling Expert Parallelism in TensorRT LLM (Part 2: Performance Status and Optimization)

# Scaling Expert Parallelism in TensorRT LLM (Part 2: Performance Status and Optimization)[#](#scaling-expert-parallelism-in-tensorrt-llm-part-2-performance-status-and-optimization "Link to this heading")
...
## Optimization Highlights[#](#optimization-highlights "Link to this heading")
...
### Kernel Optimizations[#](#kernel-optimizations "Link to this heading")
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog8_kernel_breakdown.png)

*Figure 1: Kernel breakdown when scaling EP without EPLB.*
...
#### MoE Auxiliary Kernels[#](#moe-auxiliary-kernels "Link to this heading")
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog8_moe_aux_kernels1.png)

*Figure 2: Sparsity of valid expanded tokens. For DeepSeek-R1 deployed with EP 32, a batch of 12 tokens are expanded to 96 tokens, but only 3 are valid on rank 0.*
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog8_moe_aux_kernels2.png)

*Figure 3: Optimization effect on MoE auxiliary kernels. (Left) Before optimization, kernel time increases with EP size. (Right) After optimization, kernel time remains constant with EP size.*

#### Communication Kernels[#](#communication-kernels "Link to this heading")
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog8_communication_kernel.png)

*Figure 4: Optimization effect on communication kernels.*

### Expert Parallelism Load Balancer (EPLB)[#](#expert-parallelism-load-balancer-eplb "Link to this heading")
...
#### Attempts at Online EPLB Implementation[#](#attempts-at-online-eplb-implementation "Link to this heading")
...
##### 1. Initial Approach for Weight Updating - cudaMemcpyAsync[#](#initial-approach-for-weight-updating-cudamemcpyasync "Link to this heading")
...
##### 2. Avoiding Deadlock - Multithreaded CPU Copy with Managed Memory[#](#avoiding-deadlock-multithreaded-cpu-copy-with-managed-memory "Link to this heading")
...
##### 3. NUMA Memory to Prevent Page Migration[#](#numa-memory-to-prevent-page-migration "Link to this heading")
...
##### 4. Addressing the TLB Thrashing Issue[#](#addressing-the-tlb-thrashing-issue "Link to this heading")
...
The `numa_alloc_onnode` function may use this page size, which is too small for efficient GPU kernel execution. Linux systems support [HugeTLB Pages](https://docs.kernel.org/admin-guide/mm/hugetlbpage.md), and on GB200 systems, the huge page size is 512 MB:
...
### Multi-Token Prediction (MTP)[#](#multi-token-prediction-mtp "Link to this heading")
...
### Host Overhead Optimization[#](#host-overhead-optimization "Link to this heading")
...
#### Reduce Binding and Inter-Process Communication Overhead[#](#reduce-binding-and-inter-process-communication-overhead "Link to this heading")
...
#### Support Stream Interval[#](#support-stream-interval "Link to this heading")
...
## End-to-End Performance[#](#end-to-end-performance "Link to this heading")
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog8_perf-1k-1k-dep.png)

*Figure 5: DeepSeek R1 throughput on ISL/OSL 1k/1k.*

![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog8_perf-4k-1k-dep.png)

*Figure 6: DeepSeek R1 throughput on ISL/OSL 4k/1k.*

![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog8_perf-8k-1k-dep.png)

*Figure 7: DeepSeek R1 throughput on ISL/OSL 8k/1k.*
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog8_perf-8k-1k-e2e-mtp.png)
...
### Further Performance Optimization[#](#further-performance-optimization "Link to this heading")
...
N-Gram Speculative Decoding in TensorRT LLM](blog7_NGram_performance_Analysis_And_Auto_Enablement.md "previous page")
[next

Running a High Performance GPT-OSS-120B Inference Server with TensorRT LLM](blog9_Deploying_GPT_OSS_on_TRTLLM.md "next page")
...
* [Optimization Highlights](#optimization-highlights)
  ...
  + [Expert Parallelism Load Balancer (EPLB)](#expert-parallelism-load-balancer-eplb)
    - [Attempts at Online EPLB Implementation](#attempts-at-online-eplb-implementation)
      * [1. Initial Approach for Weight Updating - cudaMemcpyAsync](#initial-approach-for-weight-updating-cudamemcpyasync)
      * [2. Avoiding Deadlock - Multithreaded CPU Copy with Managed Memory](#avoiding-deadlock-multithreaded-cpu-copy-with-managed-memory)
      * [3. NUMA Memory to Prevent Page Migration](#numa-memory-to-prevent-page-migration)
      * [4. Addressing the TLB Thrashing Issue](#addressing-the-tlb-thrashing-issue)
  + [Multi-Token Prediction (MTP)](#multi-token-prediction-mtp)
  + [Host Overhead Optimization](#host-overhead-optimization)
    - [Reduce Binding and Inter-Process Communication Overhead](#reduce-binding-and-inter-process-communication-overhead)
    - [Support Stream Interval](#support-stream-interval)
