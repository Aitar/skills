Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/blogs/tech_blog/blog5_Disaggregated_Serving_in_TensorRT-LLM.md

* Disaggregated Serving in TensorRT LLM

# Disaggregated Serving in TensorRT LLM[#](#disaggregated-serving-in-tensorrt-llm "Link to this heading")
...
* [Disaggregated Serving in TensorRT LLM](#disaggregated-serving-in-tensorrt-llm)
  ...
  + [Disaggregated Serving in TensorRT LLM](#id1)
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog5_Picture1.png)
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog5_Picture2.png)
...
## Disaggregated Serving in TensorRT LLM[#](#id1 "Link to this heading")
...
[`trtllm-serve`](https://nvidia.github.io/TensorRT-LLM/commands/trtllm-serve.md) is a command-line utility that facilitates the deployment of an OpenAI-compatible server for TensorRT LLM instances.
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog5_Picture3.png)
...
### Dynamo[#](#dynamo "Link to this heading")
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog5_Picture6.png)

*Figure 6. KV cache exchange architecture*

### Overlap Optimization[#](#overlap-optimization "Link to this heading")
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog5_Picture7.png)

*Figure 7. KV cache exchange timing diagram*

### Cache Layout Transformation[#](#cache-layout-transformation "Link to this heading")
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog5_Picture8.png)
...
## Performance Studies[#](#performance-studies "Link to this heading")

### Measurement Methodology[#](#measurement-methodology "Link to this heading")
...
### DeepSeek R1[#](#deepseek-r1 "Link to this heading")
...
#### ISL 4400 - OSL 1200 (Machine Translation Dataset)[#](#isl-4400-osl-1200-machine-translation-dataset "Link to this heading")

![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog5_Picture9.png)
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog5_Picture10.png)
...
#### ISL 8192 - OSL 256 (Synthetic Dataset)[#](#isl-8192-osl-256-synthetic-dataset "Link to this heading")

![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog5_Picture11.png)

*Figure 11. DeepSeek R1 4-GPU Pareto curve. ctx/gen=4.5 means SOL rate matching between context and generation phase, which is only used for SOL perf result collection purpose. c4dep4\_g1dep4 means 4 DEP4 context instances plus 1 DEP4 generation instance form a full LLM serving instance.*

![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog5_Picture12.png)
...
#### ISL 4096 - OSL 1024 (Machine Translation Dataset)[#](#isl-4096-osl-1024-machine-translation-dataset "Link to this heading")

![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog5_Picture13.png)
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog5_Picture14.png)
...
### Qwen 3[#](#qwen-3 "Link to this heading")

#### ISL 8192 - OSL 1024 (Machine Translation Dataset)[#](#isl-8192-osl-1024-machine-translation-dataset "Link to this heading")

![Qwen 3 Pareto curves](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog5_Picture15.png)
...
## Future Work[#](#future-work "Link to this heading")
...
Scaling Expert Parallelism in TensorRT LLM (Part 1: Design and Implementation of Large-scale EP)](blog4_Scaling_Expert_Parallelism_in_TensorRT-LLM.md "previous page")
[next

How to launch Llama4 Maverick + Eagle3 TensorRT LLM server](blog6_Llama4_maverick_eagle_guide.md "next page")
