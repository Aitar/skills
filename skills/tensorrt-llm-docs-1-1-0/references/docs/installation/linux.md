Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/installation/linux.md

* [Installation](index.md)
* Installing on Linux via `pip`

# Installing on Linux via `pip`[#](#installing-on-linux-via-pip "Link to this heading")
...
1. Install TensorRT LLM (tested on Ubuntu 24.04).
   ...
   driver version. For additional information, refer to the [CUDA Forward Compatibility](https://docs.nvidia.com/deploy/cuda-compatibility/forward-compatibility.md).
   ...
   (see [here](containers.md#containers) for information on container tags).
