Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/developer-guide/dev-containers.md

* Using Dev Containers

# Using Dev Containers[#](#using-dev-containers "Link to this heading")
...
[Building from Source Code on Linux](../installation/build-from-source-linux.md) and
[NVIDIA/TensorRT-LLM](https://github.com/NVIDIA/TensorRT-LLM/tree/main/docker)), the Dev
...
## Container image selection[#](#container-image-selection "Link to this heading")
...
2. Use the most recent
   ...
   out commit.
3. Build a development image locally.
...
## Volume Mounts[#](#volume-mounts "Link to this heading")
...
## Overriding Docker Compose configuration[#](#overriding-docker-compose-configuration "Link to this heading")
...
Continuous Integration Overview](ci-overview.md "previous page")
[next

LLM API Change Guide](api-change.md "next page")

On this page

* [Container image selection](#container-image-selection)
* [Volume Mounts](#volume-mounts)
* [Overriding Docker Compose configuration](#overriding-docker-compose-configuration)