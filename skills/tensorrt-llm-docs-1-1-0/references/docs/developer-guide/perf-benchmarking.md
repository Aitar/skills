Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/developer-guide/perf-benchmarking.md

* TensorRT LLM Benchmarking

# TensorRT LLM Benchmarking[#](#tensorrt-llm-benchmarking "Link to this heading")
...
## Before Benchmarking[#](#before-benchmarking "Link to this heading")
...
### Persistence mode[#](#persistence-mode "Link to this heading")
...
### GPU Clock Management[#](#gpu-clock-management "Link to this heading")
...
### Set power limits[#](#set-power-limits "Link to this heading")
...
### Boost settings[#](#boost-settings "Link to this heading")
...
## Throughput Benchmarking[#](#throughput-benchmarking "Link to this heading")

### Limitations and Caveats[#](#limitations-and-caveats "Link to this heading")

#### Validated Networks for Benchmarking[#](#validated-networks-for-benchmarking "Link to this heading")
...
#### Supported Quantization Modes[#](#supported-quantization-modes "Link to this heading")
...
For more information about quantization, refer to [Quantization](../features/quantization.md) and
...
### Running with the PyTorch Workflow[#](#running-with-the-pytorch-workflow "Link to this heading")
...
#### Benchmarking with LoRA Adapters in PyTorch workflow[#](#benchmarking-with-lora-adapters-in-pytorch-workflow "Link to this heading")
...
#### Running multi-modal models in the PyTorch Workflow[#](#running-multi-modal-models-in-the-pytorch-workflow "Link to this heading")
...
#### Quantization in the PyTorch Flow[#](#quantization-in-the-pytorch-flow "Link to this heading")
...
To understand more about how to quantize your own checkpoints, refer to ModelOpt [documentation](https://nvidia.github.io/Model-Optimizer/deployment/3_unified_hf.md).
...
## Online Serving Benchmarking[#](#online-serving-benchmarking "Link to this heading")
...
Performance Analysis](perf-analysis.md "previous page")
[next

Continuous Integration Overview](ci-overview.md "next page")
