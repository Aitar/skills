Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/developer-guide/perf-overview.md
...
## Throughput Measurements[#](#throughput-measurements "Link to this heading")
...
### Hardware[#](#hardware "Link to this heading")
...
### FP4 Models[#](#fp4-models "Link to this heading")
...
### FP8 Models[#](#fp8-models "Link to this heading")
...
# Performance Summary - All Networks[#](#performance-summary-all-networks "Link to this heading")
...
The calculations for metrics reported by trtllm-bench can be found in the dataclasses [reporting.py](../_downloads/24a8176e5dad1c0d69d446f5fd6515b0/reporting.py) and [statistics.py](../_downloads/071b23b9a0344fabc6867e005e746574/statistics.py)
...
# Deepseek R1 0528[#](#deepseek-r1-0528 "Link to this heading")
...
# GPT-OSS 120B[#](#gpt-oss-120b "Link to this heading")

| Sequence Length (ISL/OSL) | B200 DEP2 (FP4) | GB200 TP1 (FP4) | H200 TP1 (FP8) | H100 DEP4 (FP8) |
| --- | --- | --- | --- | --- |
...
# GPT-OSS 20B[#](#gpt-oss-20b "Link to this heading")

| Sequence Length (ISL/OSL) | B200 TP1 (FP4) | GB200 TP1 (FP4) | H200 TP1 (FP8) | H100 TP1 (FP8) |
| --- | --- | --- | --- | --- |
...
# LLaMA v3.3 70B[#](#llama-v3-3-70b "Link to this heading")

| Sequence Length (ISL/OSL) | B200 TP1 (FP4) | GB200 TP1 (FP4) | H200 TP2 (FP8) | H100 TP2 (FP8) |
| --- | --- | --- | --- | --- |
...
# LLaMA v3.3 70B - RTX 6000 Pro Blackwell Server Edition[#](#llama-v3-3-70b-rtx-6000-pro-blackwell-server-edition "Link to this heading")

*Shows Tensor Parallel (TP) and Pipeline Parallel (PP) configurations*

| Sequence Length (ISL/OSL) | **1 GPUs** TP1,PP1 (FP4) | **2 GPUs** TP1,PP2 (FP4) |
| --- | --- | --- |
...
# LLaMA v4 Maverick[#](#llama-v4-maverick "Link to this heading")
...
# Qwen3 235B A22B[#](#qwen3-235b-a22b "Link to this heading")

| Sequence Length (ISL/OSL) | B200 DEP4 (FP4) | GB200 DEP4 (FP4) | H200 DEP4 (FP8) | H100 DEP8 (FP8) |
| --- | --- | --- | --- | --- |
...
# Qwen3 235B A22B - RTX 6000 Pro Blackwell Server Edition[#](#qwen3-235b-a22b-rtx-6000-pro-blackwell-server-edition "Link to this heading")

*Shows Tensor Parallel (TP) and Pipeline Parallel (PP) configurations*

| Sequence Length (ISL/OSL) | **4 GPUs** DEP2,PP2 (FP4) | **8 GPUs** DEP8,PP1 (FP4) |
| --- | --- | --- |
| 1000/1000 | 1,731 | 969 |
| 1024/1024 | 1,732 | 963 |
| 1024/8192 | 644 | 711 |
...
# Qwen3 30B A3B[#](#qwen3-30b-a3b "Link to this heading")

| Sequence Length (ISL/OSL) | B200 TP1 (FP4) | GB200 TP1 (FP4) |
| --- | --- | --- |
...
# Qwen3 30B A3B - RTX 6000 Pro Blackwell Server Edition[#](#qwen3-30b-a3b-rtx-6000-pro-blackwell-server-edition "Link to this heading")

*Shows Tensor Parallel (TP) and Pipeline Parallel (PP) configurations*

| Sequence Length (ISL/OSL) | **2 GPUs** DEP2,PP1 (FP4) | **4 GPUs** DEP2,PP2 (FP4) | **8 GPUs** DEP8,PP1 (FP4) | **1 GPUs** TP1,PP1 (FP4) |
| --- | --- | --- | --- | --- |
...
## Reproducing Benchmarked Results[#](#reproducing-benchmarked-results "Link to this heading")
...
### Command Overview[#](#command-overview "Link to this heading")
...
### Preparing a Dataset[#](#preparing-a-dataset "Link to this heading")

In order to prepare a dataset, you can use the provided [script](https://github.com/NVIDIA/TensorRT-LLM/tree/48b7b5d/benchmarks/cpp/prepare_dataset.py).
...
### Running the Benchmark[#](#running-the-benchmark "Link to this heading")
...
a model name (HuggingFace reference or path to a local model), a [generated dataset](#preparing-a-dataset), and a file containing any desired extra options to the LLM APIs (details in [tensorrt\_llm/llmapi/llm\_args.py:LlmArgs](https://github.com/NVIDIA/TensorRT-LLM/tree/48b7b5d/tensorrt_llm/llmapi/llm_args.py)).
...
* [GPT-OSS 20B](#gpt-oss-20b)
* [LLaMA v3.3 70B](#llama-v3-3-70b)
* [LLaMA v3.3 70B - RTX 6000 Pro Blackwell Server Edition](#llama-v3-3-70b-rtx-6000-pro-blackwell-server-edition)
* [LLaMA v4 Maverick](#llama-v4-maverick)
* [Qwen3 235B A22B](#qwen3-235b-a22b)
