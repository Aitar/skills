Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/developer-guide/ci-overview.md

* Continuous Integration Overview

# Continuous Integration Overview[#](#continuous-integration-overview "Link to this heading")
...
## Test definitions[#](#test-definitions "Link to this heading")
...
## Jenkins stage names[#](#jenkins-stage-names "Link to this heading")
...
## Finding the stage for a test[#](#finding-the-stage-for-a-test "Link to this heading")
...
### Using `test_to_stage_mapping.py`[#](#using-test-to-stage-mapping-py "Link to this heading")
...
## Waiving tests[#](#waiving-tests "Link to this heading")
...
## Triggering CI Best Practices[#](#triggering-ci-best-practices "Link to this heading")

### Triggering Post-merge tests[#](#triggering-post-merge-tests "Link to this heading")
...
### Avoiding unnecessary `--disable-fail-fast` usage[#](#avoiding-unnecessary-disable-fail-fast-usage "Link to this heading")
...
TensorRT LLM Benchmarking](perf-benchmarking.md "previous page")
[next

Using Dev Containers](dev-containers.md "next page")
...
* [Jenkins stage names](#jenkins-stage-names)
* [Finding the stage for a test](#finding-the-stage-for-a-test)
  + [Using `test_to_stage_mapping.py`](#using-test-to-stage-mapping-py)
* [Waiving tests](#waiving-tests)
* [Triggering CI Best Practices](#triggering-ci-best-practices)
  + [Triggering Post-merge tests](#triggering-post-merge-tests)
  + [Avoiding unnecessary `--disable-fail-fast` usage](#avoiding-unnecessary-disable-fail-fast-usage)