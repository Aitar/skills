Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/features/guided-decoding.md
...
* [XGrammar](https://github.com/mlc-ai/xgrammar/blob/v0.1.21/python/xgrammar/matcher.py#L341-L350): Supports JSON schema, regular expression, EBNF and [structural tag](https://xgrammar.mlc.ai/docs/tutorials/structural_tag.md).
...
## Online API: `trtllm-serve`[#](#online-api-trtllm-serve "Link to this heading")
...
### Regular expression[#](#regular-expression "Link to this heading")
...
### EBNF grammar[#](#ebnf-grammar "Link to this heading")
...
## Offline API: LLM API[#](#offline-api-llm-api "Link to this heading")
...
### JSON Schema[#](#id1 "Link to this heading")
...
### Regular expression[#](#id2 "Link to this heading")
...
### EBNF grammar[#](#id3 "Link to this heading")
...
### Structural tag[#](#id4 "Link to this heading")
...
Sampling](sampling.md "previous page")
[next

Speculative Decoding](speculative-decoding.md "next page")

On this page

* [Online API: `trtllm-serve`](#online-api-trtllm-serve)
  + [JSON Schema](#json-schema)
  + [Regular expression](#regular-expression)
  + [EBNF grammar](#ebnf-grammar)
  + [Structural tag](#structural-tag)
* [Offline API: LLM API](#offline-api-llm-api)
  + [JSON Schema](#id1)
  + [Regular expression](#id2)
  + [EBNF grammar](#id3)
  + [Structural tag](#id4)