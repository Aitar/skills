Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/features/kvcache.md

* KV Cache System

# KV Cache System[#](#kv-cache-system "Link to this heading")
...
## Reuse Across Requests[#](#reuse-across-requests "Link to this heading")
...
## Limited Attention Window Size[#](#limited-attention-window-size "Link to this heading")
...
## MQA / GQA[#](#mqa-gqa "Link to this heading")
...
## Controlling KV Cache Behavior[#](#controlling-kv-cache-behavior "Link to this heading")

Many of the features in the KV cache system are optional or have user defined properties that alter how they work. Users can control KV cache features through class [KVCacheConfig](https://nvidia.github.io/TensorRT-LLM/llm-api/reference.md#tensorrt_llm.llmapi.KvCacheConfig). The remainder of this section describes how to change the most important behaviors of the KV cache system.
...
### How Much Memory is Allocated to KV Cache[#](#how-much-memory-is-allocated-to-kv-cache "Link to this heading")
...
### Enable/Disable Cross Request Reuse[#](#enable-disable-cross-request-reuse "Link to this heading")

Block reuse across requests is enabled by default, but can be disabled by setting `enable_block_reuse` to False.

### KV Cache Salting for Secure Reuse[#](#kv-cache-salting-for-secure-reuse "Link to this heading")
...
### Enable Offloading to Host Memory[#](#enable-offloading-to-host-memory "Link to this heading")
...
Here is an [example](../_downloads/289baa7eb9a76c4944f3e2800f51f4c4/llm_kv_cache_offloading.py) to show how to enable host offloading.

### Partial Reuse[#](#partial-reuse "Link to this heading")
...
### Attention Window Size[#](#attention-window-size "Link to this heading")
...
### Deprecated Properties[#](#deprecated-properties "Link to this heading")

Properties `use_uvm` and `sink_token_length` have been deprecated and will be removed in a future release.

[previous

Disaggregated Serving (Beta)](disagg-serving.md "previous page")
[next

Long Sequences](long-sequence.md "next page")

On this page

* [The Basics](#the-basics)
* [Reuse Across Requests](#reuse-across-requests)
  + [Retention Policy](#retention-policy)
  + [Speculative Decoding](#speculative-decoding)
* [Limited Attention Window Size](#limited-attention-window-size)
* [MQA / GQA](#mqa-gqa)
* [Controlling KV Cache Behavior](#controlling-kv-cache-behavior)
  + [Datatype](#datatype)
  + [How Much Memory is Allocated to KV Cache](#how-much-memory-is-allocated-to-kv-cache)
  + [Enable/Disable Cross Request Reuse](#enable-disable-cross-request-reuse)
  + [KV Cache Salting for Secure Reuse](#kv-cache-salting-for-secure-reuse)
  + [Enable Offloading to Host Memory](#enable-offloading-to-host-memory)
  + [Partial Reuse](#partial-reuse)
  + [Attention Window Size](#attention-window-size)
