Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/features/parallel-strategy.md

* Parallelism in TensorRT LLM

# Parallelism in TensorRT LLM[#](#parallelism-in-tensorrt-llm "Link to this heading")
...
## Overview of Parallelism Strategies[#](#overview-of-parallelism-strategies "Link to this heading")
...
### Expert Parallelism (EP)[#](#expert-parallelism-ep "Link to this heading")
...
### Context Parallelism (CP)[#](#context-parallelism-cp "Link to this heading")

Context parallelism distributes the processing of long sequences across multiple GPUs.

**Best for:** Long context scenarios

### Wide Expert Parallelism (Wide-EP)[#](#wide-expert-parallelism-wide-ep "Link to this heading")
...
## Module-level Parallelism Guide[#](#module-level-parallelism-guide "Link to this heading")

### Attention Module[#](#attention-module "Link to this heading")
...
#### Tensor Parallelism (TP)[#](#id1 "Link to this heading")
...
#### Data Parallelism (DP)[#](#id2 "Link to this heading")
...
#### How to Enable Attention Parallelism[#](#how-to-enable-attention-parallelism "Link to this heading")
...
### FFN Module[#](#ffn-module "Link to this heading")

#### Dense Models[#](#dense-models "Link to this heading")

Tensor Parallelism is supported for the FFN layers of dense models.

#### Mixture of Experts (MoE)[#](#mixture-of-experts-moe "Link to this heading")
...
#### How to Enable MoE Parallelism[#](#how-to-enable-moe-parallelism "Link to this heading")
...
## Wide Expert Parallelism (Wide-EP)[#](#id3 "Link to this heading")
...
### Motivation for Wide-EP[#](#motivation-for-wide-ep "Link to this heading")
...
### Key Features of Wide-EP[#](#key-features-of-wide-ep "Link to this heading")

#### 1. Expert Replication and Load Balancing[#](#expert-replication-and-load-balancing "Link to this heading")
...
#### 2. Custom EP Communication Kernels[#](#custom-ep-communication-kernels "Link to this heading")
...
#### 3. Expert Parallelism Load Balancer (EPLB)[#](#expert-parallelism-load-balancer-eplb "Link to this heading")
...
4. **Tune max\_num\_tokens** based on your memory constraints and EP size
...
Paged Attention, IFB, and Request Scheduling](paged-attention-ifb-scheduler.md "previous page")
[next

Quantization](quantization.md "next page")

On this page

* [Overview of Parallelism Strategies](#overview-of-parallelism-strategies)
...
* [Module-level Parallelism Guide](#module-level-parallelism-guide)
  + [Attention Module](#attention-module)
    - [Tensor Parallelism (TP)](#id1)
    - [Data Parallelism (DP)](#id2)
    - [How to Enable Attention Parallelism](#how-to-enable-attention-parallelism)
  + [FFN Module](#ffn-module)
    - [Dense Models](#dense-models)
    - [Mixture of Experts (MoE)](#mixture-of-experts-moe)
    - [How to Enable MoE Parallelism](#how-to-enable-moe-parallelism)
* [Wide Expert Parallelism (Wide-EP)](#id3)
  + [Motivation for Wide-EP](#motivation-for-wide-ep)
  + [Key Features of Wide-EP](#key-features-of-wide-ep)
    - [1. Expert Replication and Load Balancing](#expert-replication-and-load-balancing)
    - [2. Custom EP Communication Kernels](#custom-ep-communication-kernels)
    - [3. Expert Parallelism Load Balancer (EPLB)](#expert-parallelism-load-balancer-eplb)
