Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/features/auto_deploy/advanced/expert_configurations.md

* Expert Configuration of LLM API

# Expert Configuration of LLM API[#](#expert-configuration-of-llm-api "Link to this heading")
...
# Expert Configuration of `build_and_run_ad.py`[#](#expert-configuration-of-build-and-run-ad-py "Link to this heading")
...
## CLI Arguments with Dot Notation[#](#cli-arguments-with-dot-notation "Link to this heading")
...
## YAML Configuration Files[#](#yaml-configuration-files "Link to this heading")
...
## Configuration Precedence and Deep Merging[#](#configuration-precedence-and-deep-merging "Link to this heading")
...
## Built-in Default Configuration[#](#built-in-default-configuration "Link to this heading")
...
* [Expert Configuration of LLM API](#)
* [Expert Configuration of `build_and_run_ad.py`](#expert-configuration-of-build-and-run-ad-py)
  + [CLI Arguments with Dot Notation](#cli-arguments-with-dot-notation)
  + [YAML Configuration Files](#yaml-configuration-files)
  + [Configuration Precedence and Deep Merging](#configuration-precedence-and-deep-merging)
