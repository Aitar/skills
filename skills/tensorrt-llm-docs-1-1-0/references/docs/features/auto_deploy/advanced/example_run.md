Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/features/auto_deploy/advanced/example_run.md

* Example Run Script

# Example Run Script[#](#example-run-script "Link to this heading")
