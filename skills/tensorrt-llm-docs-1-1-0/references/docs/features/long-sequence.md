Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/features/long-sequence.md

* Long Sequences

# Long Sequences[#](#long-sequences "Link to this heading")
...
## Chunked attention[#](#chunked-attention "Link to this heading")

![feat_long_seq_chunked_attention](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/media/feat_long_seq_chunked_attention.png)
...
## Sliding Window Attention[#](#sliding-window-attention "Link to this heading")

![feat_long_seq_sliding_win_attn](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/media/feat_long_seq_chunked_attention.png)
...
KV Cache System](kvcache.md "previous page")
[next

LoRA (Low-Rank Adaptation)](lora.md "next page")
