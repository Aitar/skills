Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/features/checkpoint-loading.md

* Checkpoint Loading

# Checkpoint Loading[#](#checkpoint-loading "Link to this heading")
...
### BaseCheckpointLoader[#](#basecheckpointloader "Link to this heading")
...
### BaseConfigLoader[#](#baseconfigloader "Link to this heading")
...
### BaseWeightLoader[#](#baseweightloader "Link to this heading")
...
### BaseWeightMapper[#](#baseweightmapper "Link to this heading")
...
## Built-in Checkpoint Formats[#](#built-in-checkpoint-formats "Link to this heading")

### HuggingFace Format[#](#huggingface-format "Link to this heading")
...
## Using Checkpoint Loaders[#](#using-checkpoint-loaders "Link to this heading")
...
## Creating Custom Checkpoint Loaders[#](#creating-custom-checkpoint-loaders "Link to this heading")
...
### When to Create Custom Components[#](#when-to-create-custom-components "Link to this heading")
...
### Step 1: Create the Checkpoint Loader[#](#step-1-create-the-checkpoint-loader "Link to this heading")
...
### Step 2: Create the Checkpoint Weight Loader[#](#step-2-create-the-checkpoint-weight-loader "Link to this heading")
...
### Step 3: Create the Checkpoint Config Loader[#](#step-3-create-the-checkpoint-config-loader "Link to this heading")
...
### Step 4: Create the Checkpoint Weight Mapper[#](#step-4-create-the-checkpoint-weight-mapper "Link to this heading")
...
Speculative Decoding](speculative-decoding.md "previous page")
[next

AutoDeploy (Prototype)](auto_deploy/auto-deploy.md "next page")
...
* [Built-in Checkpoint Formats](#built-in-checkpoint-formats)
  + [HuggingFace Format](#huggingface-format)
* [Using Checkpoint Loaders](#using-checkpoint-loaders)
  + [Basic Usage](#basic-usage)
* [Creating Custom Checkpoint Loaders](#creating-custom-checkpoint-loaders)
  + [When to Create Custom Components](#when-to-create-custom-components)
  + [Step 1: Create the Checkpoint Loader](#step-1-create-the-checkpoint-loader)
  + [Step 2: Create the Checkpoint Weight Loader](#step-2-create-the-checkpoint-weight-loader)
  + [Step 3: Create the Checkpoint Config Loader](#step-3-create-the-checkpoint-config-loader)
  + [Step 4: Create the Checkpoint Weight Mapper](#step-4-create-the-checkpoint-weight-mapper)