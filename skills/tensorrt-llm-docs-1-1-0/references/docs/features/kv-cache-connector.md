Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/features/kv-cache-connector.md

* KV Cache Connector

# KV Cache Connector[#](#kv-cache-connector "Link to this heading")
...
#### 1. Scheduler (Leader) Interface (`KvCacheConnectorScheduler`)[#](#scheduler-leader-interface-kvcacheconnectorscheduler "Link to this heading")
...
#### 2. Worker Interface (`KvCacheConnectorWorker`)[#](#worker-interface-kvcacheconnectorworker "Link to this heading")
...
### Limitations & Patterns[#](#limitations-patterns "Link to this heading")
...
AutoDeploy (Prototype)](auto_deploy/auto-deploy.md "previous page")
[next

Architecture Overview](../developer-guide/overview.md "next page")
...
* [Architecture](#architecture)
  + [API Reference](#api-reference)
    - [1. Scheduler (Leader) Interface (`KvCacheConnectorScheduler`)](#scheduler-leader-interface-kvcacheconnectorscheduler)
    - [2. Worker Interface (`KvCacheConnectorWorker`)](#worker-interface-kvcacheconnectorworker)
* [Example Implementation](#example-implementation)
  + [Overview](#overview)
  + [Implementation Details](#implementation-details)
  + [Limitations & Patterns](#limitations-patterns)
  + [Usage](#usage)