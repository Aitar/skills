# Custom Indicators: Plot Types

Source: https://www.tradingview.com/charting-library-docs/v29/custom_studies/Custom-Studies-Plots

* [Custom Indicators](/charting-library-docs/v29/custom_studies/)* Plot Types
...
The `plots` field is located in [metainfo](/charting-library-docs/v29/custom_studies/metainfo/) and contains an array with plots info.
...
## Colorer[​](#colorer "Direct link to Colorer")

* `type`- 'colorer'
* `palette`- string
* `target`- string

## DataOffset[​](#dataoffset "Direct link to DataOffset")
...
## BarColorer[​](#barcolorer "Direct link to BarColorer")

* `type`- 'bar\_colorer'
* `palette`- string

## BgColorer[​](#bgcolorer "Direct link to BgColorer")

* `type`- 'bg\_colorer'
* `palette`- string

## TextColorer[​](#textcolorer "Direct link to TextColorer")

* `type`- 'text\_colorer'
* `palette`- string
* `target`- string

## OhlcColorer[​](#ohlccolorer "Direct link to OhlcColorer")
