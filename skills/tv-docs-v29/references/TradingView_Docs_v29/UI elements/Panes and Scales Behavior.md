# UI elements: Panes and Scales Behavior

Source: https://www.tradingview.com/charting-library-docs/v29/ui_elements/Panes-And-Scales-Behavior

* [UI elements](/charting-library-docs/v29/ui_elements/)* Panes and Scales Behavior

On this page

# Panes and Scales Behavior

## Panes and scales behavior[​](#panes-and-scales-behavior "Direct link to Panes and scales behavior")
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Value Price Study or Non-Price Study with force\_overlay=true Non-Price Study with force\_overlay=false|  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | new-left place on a new left scale of the main pane place on a new left scale of a new pane|  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | | new-right place on a new right scale of the main pane place on a new right scale of a new pane|  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | | no-scale place as "no scale" on the main pane place as "no scale" on a new pane|  |  |  | | --- | --- | --- | | as-series place on the same price scale as the main series place on a separate pane on the right price scale | | | | | | | | | | | | | | |