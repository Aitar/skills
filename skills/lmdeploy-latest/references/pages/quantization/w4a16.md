...
Source: https://lmdeploy.readthedocs.io/en/latest/quantization/w4a16.html
...
Out of Memory error during quantization due to insufficient GPU memory: This can be addressed by reducing the parameter `--calib-seqlen`, increasing the parameter `--calib-samples`, and set `--batch-size` to 1.
