# Serving LoRA — lmdeploy

Source: https://lmdeploy.readthedocs.io/en/latest/llm/api_server_lora.html
...
LoRA is currently only supported by the PyTorch backend. Its deployment process is similar to that of other models, and you can view the commands using lmdeploy `serveapi_server-h`. Among the parameters supported by the PyTorch backend, there are configuration options for LoRA.
