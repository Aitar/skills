# Reasoning Outputs — lmdeploy

Source: https://lmdeploy.readthedocs.io/en/latest/llm/api_server_reasoning.html

Reasoning Outputs

Reasoning Outputs#

For models that support reasoning capabilities, such as DeepSeek R1, LMDeploy supports parsing the reasoning results in the service and separately records the reasoning content using `reasoning_content`.
