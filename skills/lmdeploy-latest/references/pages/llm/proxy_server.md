# Request Distributor Server — lmdeploy

Source: https://lmdeploy.readthedocs.io/en/latest/llm/proxy_server.html
...
`lmdeployserveapi_serverInternLM/internlm2-chat-1_8b--proxy-urlhttp://0.0.0.0:8000`。
