# Update Weights — lmdeploy

Source: https://lmdeploy.readthedocs.io/en/latest/advance/update_weights.html
...
For pytorch backend you have to add `--distributed-executor-backendray`.
