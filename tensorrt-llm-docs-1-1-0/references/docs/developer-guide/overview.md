Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/developer-guide/overview.md
...
![TensorRT LLM Architecture Overview](../_images/TRTLLM_Architecture_Overview.png)
...
## Runtime Optimizations[#](#runtime-optimizations "Link to this heading")
...
### CUDA Graph[#](#cuda-graph "Link to this heading")
...
KV Cache Connector](../features/kv-cache-connector.md "previous page")
[next

Performance Analysis](perf-analysis.md "next page")
