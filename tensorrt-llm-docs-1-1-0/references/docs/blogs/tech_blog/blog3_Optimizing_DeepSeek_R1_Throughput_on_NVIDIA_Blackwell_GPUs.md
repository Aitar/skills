Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/blogs/tech_blog/blog3_Optimizing_DeepSeek_R1_Throughput_on_NVIDIA_Blackwell_GPUs.md

* Optimizing DeepSeek R1 Throughput on NVIDIA Blackwell GPUs: A Deep Dive for Developers

# Optimizing DeepSeek R1 Throughput on NVIDIA Blackwell GPUs: A Deep Dive for Developers[#](#optimizing-deepseek-r1-throughput-on-nvidia-blackwell-gpus-a-deep-dive-for-developers "Link to this heading")
...
## Parallel strategy[#](#parallel-strategy "Link to this heading")
...
### Weights absorb and MQA[#](#weights-absorb-and-mqa "Link to this heading")
...
![Weights Absorb](../../_images/tech_blog3_mla_absorb.png)
...
The TensorRT LLM MLA implementation chooses different highly optimized kernels for prefill and decoding, see [MLA](../../_downloads/b509390ba70e52fabb10dbd9d15d5118/attention.py).

### Data Parallel for Attention module (ADP)[#](#data-parallel-for-attention-module-adp "Link to this heading")
...
### Expert parallel for MoE (EP)[#](#expert-parallel-for-moe-ep "Link to this heading")
...
| --- | --- | --- | --- |
| shared\_fc1 | 1 | 4096 | 7168 |
| shared\_fc2 | 1 | 7168 | 2048 |
| sparse\_fc1 | 256 | 4096 | 7168 |
| sparse\_fc2 | 256 | 7168 | 2048 |
...
## MLA Layers Optimizations[#](#mla-layers-optimizations "Link to this heading")
...
## MoE Layers Optimizations[#](#moe-layers-optimizations "Link to this heading")
...
DeepSeek R1 MTP Implementation and Optimization](blog2_DeepSeek_R1_MTP_Implementation_and_Optimization.md "previous page")
[next

Scaling Expert Parallelism in TensorRT LLM (Part 1: Design and Implementation of Large-scale EP)](blog4_Scaling_Expert_Parallelism_in_TensorRT-LLM.md "next page")
