Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/blogs/tech_blog/blog7_NGram_performance_Analysis_And_Auto_Enablement.md

* N-Gram Speculative Decoding in TensorRT LLM

# N-Gram Speculative Decoding in TensorRT LLM[#](#n-gram-speculative-decoding-in-tensorrt-llm "Link to this heading")
...
## Background & Motivation[#](#background-motivation "Link to this heading")
...
## Algorithm & Complexity[#](#algorithm-complexity "Link to this heading")
...
* **Processing New Request** ‑ scan input sequence once to create N-Gram key-value pairs for the new sequence.
  ...
  With *max\_matching\_ngram\_size = 3, max\_draft\_len = 5, input\_sequence\_len=8*, Figure 1 shows the 18 new key-value pairs added to the cache pool.

  The number of cache pairs grows proportionally to the product of the maximum key length and the input sequence length.

![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog7_init_sequence_scan.png)
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog7_per_token_update.png)
...
### Experimental Setup[#](#experimental-setup "Link to this heading")
...
### Case 1 with Conversation Dataset[#](#case-1-with-conversation-dataset "Link to this heading")
...
#### Speed-up for the First Turn[#](#speed-up-for-the-first-turn "Link to this heading")

For batch size of 1, 4 and 32, we configure the max\_batch\_size of the model accordingly. We will run `20 * batch_size` number of requests with the model and compare the E2E runtime with and without N-Gram speculative decoding.

![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog7_speed_up_first_turn.png)
...
#### Effect of Multi-turn conversation[#](#effect-of-multi-turn-conversation "Link to this heading")
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog7_magpie_accepted_length_distribution.png)
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog7_al_over_iteration_magpie.png)
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog7_speed_up_second_turn.png)
...
### Case 2 with Translation Dataset[#](#case-2-with-translation-dataset "Link to this heading")
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog7_accepted_length_case2.png)

*Figure 7. Accepted Tokens from Drafts*

## Auto‑Enablement with Heuristic[#](#autoenablement-with-heuristic "Link to this heading")
...
How to launch Llama4 Maverick + Eagle3 TensorRT LLM server](blog6_Llama4_maverick_eagle_guide.md "previous page")
[next

Scaling Expert Parallelism in TensorRT LLM (Part 2: Performance Status and Optimization)](blog8_Scaling_Expert_Parallelism_in_TensorRT-LLM_part2.md "next page")
