Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/blogs/tech_blog/blog4_Scaling_Expert_Parallelism_in_TensorRT-LLM.md

* Scaling Expert Parallelism in TensorRT LLM (Part 1: Design and Implementation of Large-scale EP)

# Scaling Expert Parallelism in TensorRT LLM (Part 1: Design and Implementation of Large-scale EP)[#](#scaling-expert-parallelism-in-tensorrt-llm-part-1-design-and-implementation-of-large-scale-ep "Link to this heading")
...
* [Scaling Expert Parallelism in TensorRT LLM (Part 1: Design and Implementation of Large-scale EP)](#scaling-expert-parallelism-in-tensorrt-llm-part-1-design-and-implementation-of-large-scale-ep)
  ...
  + [E2E evaluation](#e2e-evaluation)
    ...
    - [The effect of EP Load Balancer](#the-effect-of-ep-load-balancer)
      ...
      * [Offline EP Load Balancer](#id1)
      * [Online EP Load Balancer](#id2)
    - [Performance study](#performance-study)
  + [Reproducing steps](#reproducing-steps)

    - [The effect of EP Load Balancer](#id3)
...
## Motivation for large-scale EP[#](#motivation-for-large-scale-ep "Link to this heading")
...
### Observations over one machine translation dataset[#](#observations-over-one-machine-translation-dataset "Link to this heading")

Firstly let’s have an overview of the overall imbalance issues across layers:

![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog4_Picture1.png)
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog4_Picture2.png)
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog4_Picture3.png)
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog4_Picture4.png)
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog4_Picture5.png)
...
### Observation over GSM8K dataset[#](#observation-over-gsm8k-dataset "Link to this heading")

![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog4_Picture6.png)
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog4_Picture7.png)
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog4_Picture8.png)
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog4_Picture9.png)
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog4_Picture10.png)
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog4_Picture11.png)
...
## High-level design introduction[#](#high-level-design-introduction "Link to this heading")
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog4_Picture12.png)
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog4_Picture13.png)
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog4_Picture14.png)
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog4_Picture15.png)
...
## EP communication kernels[#](#ep-communication-kernels "Link to this heading")
...
### Motivation of EP communication kernels for GB200[#](#motivation-of-ep-communication-kernels-for-gb200 "Link to this heading")
...
### EP communication kernels implementation[#](#ep-communication-kernels-implementation "Link to this heading")
...
## EP Load Balancer[#](#ep-load-balancer "Link to this heading")
...
### C++ extension[#](#c-extension "Link to this heading")

The C++ extension acts as the bridge between the PyTorch/Python interface and the C++/CUDA core implementations.

### Core implementations of the host logic[#](#core-implementations-of-the-host-logic "Link to this heading")
...
### Core implementations of the GPU logic[#](#core-implementations-of-the-gpu-logic "Link to this heading")
...
### Online EP Load Balancer[#](#online-ep-load-balancer "Link to this heading")
...
### Offline EP Load Balancer[#](#offline-ep-load-balancer "Link to this heading")
...
## E2E evaluation[#](#e2e-evaluation "Link to this heading")

### The effect of EP Load Balancer[#](#the-effect-of-ep-load-balancer "Link to this heading")

#### Offline EP Load Balancer[#](#id1 "Link to this heading")
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog4_Picture16.png)

*Figure 16: The routed token count by receiving ranks (x-axis) and iterations (y-axis) at layer 36 (No EPLB)*

![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog4_Picture17.png)
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog4_Picture18.png)
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog4_Picture19.png)
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog4_Picture20.png)
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog4_Picture21.png)
...
#### Online EP Load Balancer[#](#id2 "Link to this heading")
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog4_Picture22.png)
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog4_Picture23.png)
...
### Performance study[#](#performance-study "Link to this heading")
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog4_Picture24.png)
...
![](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog4_Picture25.png)
...
#### Step 1: Run inference and collect statistics[#](#step-1-run-inference-and-collect-statistics "Link to this heading")
...
#### Step 2: Generate the EPLB configuration[#](#step-2-generate-the-eplb-configuration "Link to this heading")
...
#### Step 3: Run inference with the EPLB configuration[#](#step-3-run-inference-with-the-eplb-configuration "Link to this heading")
...
## Expanded thoughts[#](#expanded-thoughts "Link to this heading")
...
Optimizing DeepSeek R1 Throughput on NVIDIA Blackwell GPUs: A Deep Dive for Developers](blog3_Optimizing_DeepSeek_R1_Throughput_on_NVIDIA_Blackwell_GPUs.md "previous page")
[next

Disaggregated Serving in TensorRT LLM](blog5_Disaggregated_Serving_in_TensorRT-LLM.md "next page")
