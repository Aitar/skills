Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/blogs/tech_blog/blog13_Inference_Time_Compute_Implementation_in_TensorRT-LLM.md

* Inference Time Compute Implementation in TensorRT LLM

# Inference Time Compute Implementation in TensorRT LLM[#](#inference-time-compute-implementation-in-tensorrt-llm "Link to this heading")
...
## Background and Motivation[#](#background-and-motivation "Link to this heading")
...
## Introduction for Scaffolding: A Framework for inference-time compute[#](#introduction-for-scaffolding-a-framework-for-inference-time-compute "Link to this heading")
...
### Core Features[#](#core-features "Link to this heading")
...
![Scaffolding Sequence](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog13_scaffolding_sequence.png)
...
#### ScaffoldingLlm[#](#scaffoldingllm "Link to this heading")
...
## An Example: Implement Dynasor-CoT on Scaffolding[#](#an-example-implement-dynasor-cot-on-scaffolding "Link to this heading")

Dynasor-CoT
[![arXiv](https://img.shields.io/badge/arXiv-2412.20993-b31b1b.svg?style=plastic)](https://arxiv.org/abs/2412.20993)
...
![Dynasor Demo](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog13_dynasor_demo.gif)
...
### Introduction for Dynasor-CoT[#](#introduction-for-dynasor-cot "Link to this heading")

#### Motivation of Dynasor-CoT[#](#motivation-of-dynasor-cot "Link to this heading")
...
![Motivation](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog13_dynasor_hesitation.png)
...
#### The “Probe” technique[#](#the-probe-technique "Link to this heading")
...
![Dynasor Demo](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog13_dynasor_pressure_testing.png)
...
#### How it speeds up inference[#](#how-it-speeds-up-inference "Link to this heading")
...
![Dynasor Illustration](https://github.com/NVIDIA/TensorRT-LLM/raw/main/docs/source/blogs/media/tech_blog13_dynasor_illustration.jpg)
...
### Implement Dynasor-CoT in Scaffolding[#](#implement-dynasor-cot-in-scaffolding "Link to this heading")
...
1. `proposer_task`: Handles the main content generation, producing self.chunk\_size tokens based on the previous content.
...
### Implement Dynasor-CoT based Majority Voting in Scaffolding[#](#implement-dynasor-cot-based-majority-voting-in-scaffolding "Link to this heading")
...
## Feature List on Scaffolding[#](#feature-list-on-scaffolding "Link to this heading")
...
Combining Guided Decoding and Speculative Decoding: Making CPU and GPU Cooperate Seamlessly](blog12_Combining_Guided_Decoding_and_Speculative_Decoding.md "previous page")
[next

Pushing Latency Boundaries: Optimizing DeepSeek-R1 Performance on NVIDIA B200 GPUs](blog1_Pushing_Latency_Boundaries_Optimizing_DeepSeek-R1_Performance_on_NVIDIA_B200_GPUs.md "next page")

On this page

* [Table of Contents](#table-of-contents)
* [Background and Motivation](#background-and-motivation)
* [Introduction for Scaffolding: A Framework for inference-time compute](#introduction-for-scaffolding-a-framework-for-inference-time-compute)
  + [Core Features](#core-features)
  + [Architecture](#architecture)
    - [Worker](#worker)
    - [Controller](#controller)
    - [ScaffoldingLlm](#scaffoldingllm)
* [An Example: Implement Dynasor-CoT on Scaffolding](#an-example-implement-dynasor-cot-on-scaffolding)
  + [Introduction for Dynasor-CoT](#introduction-for-dynasor-cot)
    - [Motivation of Dynasor-CoT](#motivation-of-dynasor-cot)
    - [The “Probe” technique](#the-probe-technique)
    - [How it speeds up inference](#how-it-speeds-up-inference)
  + [Implement Dynasor-CoT in Scaffolding](#implement-dynasor-cot-in-scaffolding)
  + [Implement Dynasor-CoT based Majority Voting in Scaffolding](#implement-dynasor-cot-based-majority-voting-in-scaffolding)
  + [Acknowledgements](#acknowledgements)
  + [Reference](#reference)
* [Feature List on Scaffolding](#feature-list-on-scaffolding)
