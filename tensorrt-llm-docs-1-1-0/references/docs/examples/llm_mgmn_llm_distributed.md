Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/examples/llm_mgmn_llm_distributed.md

* [LLM Examples](llm_api_examples.md)
* Run LLM-API with pytorch backend on Slurm

# Run LLM-API with pytorch backend on Slurm[#](#run-llm-api-with-pytorch-backend-on-slurm "Link to this heading")

Source [NVIDIA/TensorRT-LLM](https://github.com/NVIDIA/TensorRT-LLM/blob/48b7b5d8b7ed1e6bff57aecc6ff7d1533288bed8/examples/llm-api/llm_mgmn_llm_distributed.sh).
...
Sampling Techniques Showcase](llm_sampling.md "previous page")
[next

Run trtllm-bench with pytorch backend on Slurm](llm_mgmn_trtllm_bench.md "next page")