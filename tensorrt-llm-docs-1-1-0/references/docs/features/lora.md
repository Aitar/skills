Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/features/lora.md

* LoRA (Low-Rank Adaptation)

# LoRA (Low-Rank Adaptation)[#](#lora-low-rank-adaptation "Link to this heading")
...
### Single LoRA Adapter[#](#single-lora-adapter "Link to this heading")
...
### Multi-LoRA Support[#](#multi-lora-support "Link to this heading")
...
### LoRA with Quantization[#](#lora-with-quantization "Link to this heading")
...
### NeMo LoRA Format[#](#nemo-lora-format "Link to this heading")
...
## TRTLLM serve with LoRA[#](#trtllm-serve-with-lora "Link to this heading")

### YAML Configuration[#](#yaml-configuration "Link to this heading")
...
### Starting the Server[#](#starting-the-server "Link to this heading")
...
### Client Usage[#](#client-usage "Link to this heading")
...
## TRTLLM bench with LORA[#](#trtllm-bench-with-lora "Link to this heading")

### YAML Configuration[#](#id1 "Link to this heading")
...
### Run trtllm-bench[#](#run-trtllm-bench "Link to this heading")
...
Long Sequences](long-sequence.md "previous page")
[next

Multimodal Support in TensorRT LLM](multi-modality.md "next page")
...
* [Advanced Usage](#advanced-usage)
  ...
  + [NeMo LoRA Format](#nemo-lora-format)
  + [Cache Management](#cache-management)
* [TRTLLM serve with LoRA](#trtllm-serve-with-lora)
  + [YAML Configuration](#yaml-configuration)
  + [Starting the Server](#starting-the-server)
  + [Client Usage](#client-usage)
* [TRTLLM bench with LORA](#trtllm-bench-with-lora)
  + [YAML Configuration](#id1)
  + [Run trtllm-bench](#run-trtllm-bench)