Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/_modules/tensorrt_llm/plugin/plugin.md

* [Module code](../../index.md)
* tensorrt\_llm.plugin.plugin

# Source code for tensorrt\_llm.plugin.plugin
