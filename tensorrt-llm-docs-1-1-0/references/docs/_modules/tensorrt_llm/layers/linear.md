Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/_modules/tensorrt_llm/layers/linear.md

* [Module code](../../index.md)
* tensorrt\_llm.layers.linear

# Source code for tensorrt\_llm.layers.linear
