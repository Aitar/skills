Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/_modules/tensorrt_llm/functional.md

* [Module code](../index.md)
* tensorrt\_llm.functional

# Source code for tensorrt\_llm.functional
...
def categorical_sample(probs: Tensor, rand_data: Tensor = None) -> Tensor:
    ...
    See: https://pytorch.org/docs/stable/distributions.md#torch.distributions.categorical.Categorical.sample
...
def gather_nd(input: Tensor, indices: Tensor, batch_dims: int = 1) -> Tensor:
    ...
    See: https://onnx.ai/onnx/operators/onnx__GatherND.md
...
def masked_scatter(input: Tensor, mask: Tensor, source: Tensor) -> Tensor:
    ...
    See https://pytorch.org/docs/stable/generated/torch.Tensor.masked_scatter_.md#torch-tensor-masked-scatter for a
...
def softplus(input: Tensor, beta: float, threshold: float) -> Tensor:
    ...
    See https://pytorch.org/docs/stable/generated/torch.nn.functional.softplus.md#torch-nn-functional-softplus for a
    description of that function.
...
def allreduce(
    ...
    https://docs.nvidia.com/deeplearning/nccl/user-guide/docs/usage/collectives.md#allreduce
    for details.
...
def allgather(tensor: Tensor, group: List[int], gather_dim: int = 0) -> Tensor:
    ...
    collective operation. See
    https://docs.nvidia.com/deeplearning/nccl/user-guide/docs/usage/collectives.md#allgather
    for details.
...
def send(tensor: Tensor, tgt: int) -> Tensor:
    ...
    https://docs.nvidia.com/deeplearning/nccl/user-guide/docs/api/p2p.md#ncclsend
    for details.
...
def recv(tensor: Tensor, src: int) -> Tensor:
    ...
    point-to-point operation. See
    https://docs.nvidia.com/deeplearning/nccl/user-guide/docs/api/p2p.md#ncclrecv
    for details.
...
def meshgrid2d(x: Tensor, y: Tensor) -> Tuple[Tensor]:
    ...
    TODO: Add full support for torch.meshgrid.
          See https://pytorch.org/docs/stable/generated/torch.meshgrid.md#torch-meshgrid
    '''
    if x.ndim() == 1:
        x = expand_dims(x, 0)
    if y.ndim() == 1:
