Original URL: https://nvidia.github.io/TensorRT-LLM/1.1.0/_modules/tensorrt_llm/runtime/generation.md

* [Module code](../../index.md)
* tensorrt\_llm.runtime.generation

# Source code for tensorrt\_llm.runtime.generation
...
def CUASSERT(cuda_ret):
    ...
    if err != cudart.cudaError_t.cudaSuccess:
        raise RuntimeError(
            f"CUDA ERROR: {err}, error code reference: https://nvidia.github.io/cuda-python/module/cudart.md#cuda.cudart.cudaError_t"
        )
    if len(cuda_ret) > 1:
        return cuda_ret[1:]
    return None
