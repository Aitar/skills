# Custom Indicators: OHLC Plots

Source: https://www.tradingview.com/charting-library-docs/v29/custom_studies/Custom-Studies-OHLC-Plots

* [Custom Indicators](/charting-library-docs/v29/custom_studies/)* OHLC Plots

# Custom Studies OHLC Plots

OHLC plots can be used to create custom OHLC study with candle or bars type.

Firstly, we should add new OHLC plot to the [metainfo](/charting-library-docs/v29/custom_studies/metainfo/), using `ohlcPlots` field:
...
Last but not least you have to return data for plots from your study's `main` function in [constructor](/charting-library-docs/v29/custom_studies/custom-indicator-constructor):
