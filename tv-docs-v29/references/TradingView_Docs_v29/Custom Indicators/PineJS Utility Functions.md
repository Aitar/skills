# Custom Indicators: PineJS Utility Functions

Source: https://www.tradingview.com/charting-library-docs/v29/custom_studies/PineJS-Utility-Functions

* [Custom Indicators](/charting-library-docs/v29/custom_studies/)* PineJS Utility Functions

On this page

# PineJS Utility Functions

Custom Study [Constructor](/charting-library-docs/v29/custom_studies/custom-indicator-constructor) is able to use utility functions from PineJS object (an argument of [custom\_indicators\_getter](/charting-library-docs/v29/api/interfaces/Charting_Library.ChartingLibraryWidgetOptions#custom_indicators_getter) function).

## Functions ported from Pine[​](#functions-ported-from-pine "Direct link to Functions ported from Pine")

### `na(x)`[​](#nax "Direct link to nax")
...
### `nz(x, y)`[​](#nzx-y "Direct link to nzx-y")
...
### `and(expr1, expr2)`[​](#andexpr1-expr2 "Direct link to andexpr1-expr2")
...
### `or(expr1, expr2)`[​](#orexpr1-expr2 "Direct link to orexpr1-expr2")
...
### `not(expr)`[​](#notexpr "Direct link to notexpr")
...
### `max(x1, x2, ..., x10)`[​](#maxx1-x2--x10 "Direct link to maxx1-x2--x10")

**Returns**

The greatest of multiple values

### `min(x1, x2, ..., x10)`[​](#minx1-x2--x10 "Direct link to minx1-x2--x10")

**Returns**

The smallest of multiple given values.

### `pow(base, exponent)`[​](#powbase-exponent "Direct link to powbase-exponent")
...
### `abs(x)`[​](#absx "Direct link to absx")
...
### `log(x)`[​](#logx "Direct link to logx")
...
### `log10(x)`[​](#log10x "Direct link to log10x")
...
### `sqrt(x)`[​](#sqrtx "Direct link to sqrtx")
...
### `sign(x)`[​](#signx "Direct link to signx")
...
### `exp(x)`[​](#expx "Direct link to expx")
...
### `sin(x)`[​](#sinx "Direct link to sinx")
...
### `cos(x)`[​](#cosx "Direct link to cosx")
...
### `tan(x)`[​](#tanx "Direct link to tanx")
...
### `asin(x)`[​](#asinx "Direct link to asinx")
...
### `acos(x)`[​](#acosx "Direct link to acosx")
...
### `atan(x)`[​](#atanx "Direct link to atanx")
...
### `floor(x)`[​](#floorx "Direct link to floorx")

**Returns**

The largest integer less than or equal to the given number.

### `ceil(x)`[​](#ceilx "Direct link to ceilx")
...
### `round(x)`[​](#roundx "Direct link to roundx")
...
### `avg(x1, x2, ..., x10)`[​](#avgx1-x2--x10 "Direct link to avgx1-x2--x10")
...
### `open(context)`[​](#opencontext "Direct link to opencontext")
...
### `high(context)`[​](#highcontext "Direct link to highcontext")
...
### `low(context)`[​](#lowcontext "Direct link to lowcontext")
...
### `close(context)`[​](#closecontext "Direct link to closecontext")
...
### `hl2(context)`[​](#hl2context "Direct link to hl2context")
...
### `hlc3(context)`[​](#hlc3context "Direct link to hlc3context")
...
### `ohlc4(context)`[​](#ohlc4context "Direct link to ohlc4context")
...
### `volume(context)`[​](#volumecontext "Direct link to volumecontext")
...
### `period(context)`[​](#periodcontext "Direct link to periodcontext")
...
### `tickerid(context)`[​](#tickeridcontext "Direct link to tickeridcontext")

**Arguments**

* **`context`** PineJS execution context.

### `year(context)`[​](#yearcontext "Direct link to yearcontext")
...
### `month(context)`[​](#monthcontext "Direct link to monthcontext")
...
### `weekofyear(context)`[​](#weekofyearcontext "Direct link to weekofyearcontext")
...
### `dayofmonth(context)`[​](#dayofmonthcontext "Direct link to dayofmonthcontext")
...
### `dayofweek(context)`[​](#dayofweekcontext "Direct link to dayofweekcontext")
...
### `hour(context)`[​](#hourcontext "Direct link to hourcontext")
...
### `minute(context)`[​](#minutecontext "Direct link to minutecontext")
...
### `second(context)`[​](#secondcontext "Direct link to secondcontext")
...
### `iff(condition, then, _else)`[​](#iffcondition-then-_else "Direct link to iffcondition-then-_else")
...
### `rising(series, length)`[​](#risingseries-length "Direct link to risingseries-length")
...
### `falling(series, length)`[​](#fallingseries-length "Direct link to fallingseries-length")
...
### `rsi(upper, lower)`[​](#rsiupper-lower "Direct link to rsiupper-lower")
...
### `sum(source, length, context)`[​](#sumsource-length-context "Direct link to sumsource-length-context")
...
### `sma(source, length, context)`[​](#smasource-length-context "Direct link to smasource-length-context")
...
### `rma(source, length, context)`[​](#rmasource-length-context "Direct link to rmasource-length-context")
...
### `fixnan(current, context)`[​](#fixnancurrent-context "Direct link to fixnancurrent-context")
...
### `tr(handle_nan, context)`[​](#trhandle_nan-context "Direct link to trhandle_nan-context")
...
### `atr(length, context)`[​](#atrlength-context "Direct link to atrlength-context")
...
### `ema(series, length, context)`[​](#emaseries-length-context "Direct link to emaseries-length-context")
...
### `wma(source, length, context)`[​](#wmasource-length-context "Direct link to wmasource-length-context")
...
### `vwma(source, length, context)`[​](#vwmasource-length-context "Direct link to vwmasource-length-context")
...
### `swma(source, context)`[​](#swmasource-context "Direct link to swmasource-context")
...
### `lowestbars(source, length, context)`[​](#lowestbarssource-length-context "Direct link to lowestbarssource-length-context")
...
### `lowest(source, length, context)`[​](#lowestsource-length-context "Direct link to lowestsource-length-context")
...
### `highestbars(source, length, context)`[​](#highestbarssource-length-context "Direct link to highestbarssource-length-context")
...
### `highest(source, length, context)`[​](#highestsource-length-context "Direct link to highestsource-length-context")
...
### `cum(x, context)`[​](#cumx-context "Direct link to cumx-context")
...
### `accdist(context)`[​](#accdistcontext "Direct link to accdistcontext")
...
### `correlation(source_a, source_b, length, context)`[​](#correlationsource_a-source_b-length-context "Direct link to correlationsource_a-source_b-length-context")
...
### `stoch(source, high, low, length, context)`[​](#stochsource-high-low-length-context "Direct link to stochsource-high-low-length-context")
...
### `tsi(source, short_length, long_length, context)`[​](#tsisource-short_length-long_length-context "Direct link to tsisource-short_length-long_length-context")
...
### `cross(x, y, context)`[​](#crossx-y-context "Direct link to crossx-y-context")
...
### `linreg(source, length, offset)`[​](#linregsource-length-offset "Direct link to linregsource-length-offset")
...
### `sar(start, inc, max, context)`[​](#sarstart-inc-max-context "Direct link to sarstart-inc-max-context")
...
### `alma(series, length, offset, sigma)`[​](#almaseries-length-offset-sigma "Direct link to almaseries-length-offset-sigma")
...
### `change(source)`[​](#changesource "Direct link to changesource")
...
### `roc(source, length)`[​](#rocsource-length "Direct link to rocsource-length")
...
### `dev(source, length, context)`[​](#devsource-length-context "Direct link to devsource-length-context")
...
### `stdev(source, length, context)`[​](#stdevsource-length-context "Direct link to stdevsource-length-context")
...
### `variance(source, length, context)`[​](#variancesource-length-context "Direct link to variancesource-length-context")
...
### `percentrank(source, length)`[​](#percentranksource-length "Direct link to percentranksource-length")
...
### `dmi(diLength, adxSmoothingLength, context)`[​](#dmidilength-adxsmoothinglength-context "Direct link to dmidilength-adxsmoothinglength-context")
...
## Functions specific to the library[​](#functions-specific-to-the-library "Direct link to Functions specific to the library")
