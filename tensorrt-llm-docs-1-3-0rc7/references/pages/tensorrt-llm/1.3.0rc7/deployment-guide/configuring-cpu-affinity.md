# CPU Affinity configuration in TensorRT LLM — TensorRT LLM

Source: https://nvidia.github.io/TensorRT-LLM/1.3.0rc7/deployment-guide/configuring-cpu-affinity.html
...
See the official OpenMPI Documentation for
