# OpenAI Completion Client with JSON Schema — TensorRT LLM

Source: https://nvidia.github.io/TensorRT-LLM/1.3.0rc7/examples/openai_completion_client_json_schema.html
...
```text
 ...
 3# `xgrammar` or `llguidance` in the config.yaml file.
 4import json
 5
