# Additional Outputs — TensorRT LLM

Source: https://nvidia.github.io/TensorRT-LLM/1.3.0rc7/features/additional-outputs.html
...
For an example showing how to set the parameters and how to access the results, see examples/llm-api/quickstart_advanced.py.
