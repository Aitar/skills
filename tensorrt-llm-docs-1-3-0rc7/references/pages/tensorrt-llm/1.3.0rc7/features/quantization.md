...
Source: https://nvidia.github.io/TensorRT-LLM/1.3.0rc7/features/quantization.html
...
Note that currently TRT-LLM only supports FP8 weight/activation quantization when NVFP4 KV cache is enabled. Therefore, `--quantfp8` is required here.
...
Pre-quantized Models by ModelOpt
