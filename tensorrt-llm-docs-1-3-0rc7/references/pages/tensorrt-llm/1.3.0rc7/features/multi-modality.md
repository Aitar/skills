# Multimodal Support in TensorRT LLM — TensorRT LLM

Source: https://nvidia.github.io/TensorRT-LLM/1.3.0rc7/features/multi-modality.html
...
Please refer to the latest multimodal support matrix.
...
Evaluate offline inference performance with multimodal inputs using the `trtllm-bench` tool. For detailed instructions, see the benchmarking guide.
