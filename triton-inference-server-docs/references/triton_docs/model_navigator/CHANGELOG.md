...
## 0.14.0[#](#id1 "Link to this heading")
...
* new: Improved TorchCompile performance for repeated compilations using TORCHINDUCTOR\_CACHE\_DIR environment variable
...
* change: Install the TensorRT package for architectures other than x86\_64
...
* change: Added export\_engine to OnnxConfig for improved export control
...
* Version of external components used during testing:
  ...
  + [TensorRT 10.9.0.34](https://docs.nvidia.com/deeplearning/tensorrt/release-notes/index.md)
...
## 0.13.1[#](#id2 "Link to this heading")
...
* Version of external components used during testing:
  ...
  + [TensorRT 10.6.0.26](https://docs.nvidia.com/deeplearning/tensorrt/release-notes/index.md)
...
## 0.13.0[#](#id3 "Link to this heading")

* new: Introducing custom\_args in TensorConfig for custom runners to use which
  allows dynamic shapes setup for TorchTensorRT compilation
* new: autocast\_dtype added Torch runner configuration to set the dtype for autocast
...
## 0.12.0[#](#id4 "Link to this heading")
...
* Version of external components used during testing:
  ...
  + [TensorFlow 2.16.1](https://github.com/tensorflow/tensorflow/releases/tag/v2.16.1)
  + [TensorRT 10.3.0.26](https://docs.nvidia.com/deeplearning/tensorrt/release-notes/index.md)
...
## 0.11.0[#](#id5 "Link to this heading")
...
* change: use torch.inference\_mode or torch.no\_grad context in `nav.profile` measurements
...
* Version of external components used during testing:
  ...
  + [TensorRT 10.0.1.6](https://docs.nvidia.com/deeplearning/tensorrt/release-notes/index.md)
  + [Torch-TensorRT 2.4.0.a0](https://github.com/NVIDIA/Torch-TensorRT)
  + [ONNX Runtime 1.18.1](https://github.com/microsoft/onnxruntime/tree/v1.18.0)
...
## 0.10.1[#](#id6 "Link to this heading")
...
## 0.10.0[#](#id7 "Link to this heading")
...
## 0.9.0[#](#id8 "Link to this heading")
...
* new: inplace `nav.Module` can now receive a function name to be used instead of **call** in modules/submodules, allows
...
* fix: trt\_profiles argument handling in ONNX to TRT conversion
...
## 0.8.1[#](#id9 "Link to this heading")
...
## 0.8.0[#](#id10 "Link to this heading")
...
## 0.7.7[#](#id11 "Link to this heading")
...
* Version of external components used during testing:
  ...
  + [TensorRT 8.6.1](https://docs.nvidia.com/deeplearning/tensorrt/release-notes/index.md)
...
## 0.7.6[#](#id12 "Link to this heading")
...
## 0.7.5[#](#id13 "Link to this heading")
...
## 0.7.4[#](#id14 "Link to this heading")
...
## 0.7.3[#](#id15 "Link to this heading")
...
## 0.7.2[#](#id16 "Link to this heading")
...
## 0.7.1[#](#id17 "Link to this heading")

* fix: gather onnx input names based on modelâs forward signature
...
## 0.7.0[#](#id18 "Link to this heading")
...
* change: Navigator package version change to 0.2.3. Custom configurations now use trt\_profiles list instead single
  value
...
## 0.6.3[#](#id19 "Link to this heading")
...
## 0.6.2[#](#id20 "Link to this heading")
...
## 0.6.1[#](#id21 "Link to this heading")
...
## 0.6.0[#](#id22 "Link to this heading")
...
## 0.5.6[#](#id23 "Link to this heading")
...
## 0.5.5[#](#id24 "Link to this heading")
...
## 0.5.4[#](#id25 "Link to this heading")
...
## 0.5.3[#](#id26 "Link to this heading")

* fix: filter outputs using output\_metadata in ONNX runners
...
* Version of external components used during testing:
  ...
  + [TensorRT 8.5.3.1](https://docs.nvidia.com/deeplearning/tensorrt/release-notes/index.md)
  + [ONNX Runtime 1.13.1](https://github.com/microsoft/onnxruntime/tree/v1.13.1)
...
## 0.5.2[#](#id27 "Link to this heading")

* new: Added Contributor License Agreement (CLA)
* fix: Added missing âextra-index-url to installation instruction for pypi
...
## 0.5.1[#](#id28 "Link to this heading")
...
* Version of external components used during testing:
  ...
  + [TensorFlow 2.11.0](https://github.com/tensorflow/tensorflow/releases/tag/v2.11.0)
  + [TensorRT 8.5.3](https://docs.nvidia.com/deeplearning/tensorrt/release-notes/index.md)
  + [ONNX Runtime 1.13.1](https://github.com/microsoft/onnxruntime/tree/v1.13.1)
  + [Polygraphy](https://github.com/NVIDIA/TensorRT/tree/master/tools/Polygraphy/): 0.44.2
  + [GraphSurgeon](https://github.com/NVIDIA/TensorRT/tree/master/tools/onnx-graphsurgeon/): 0.4.6
...
## 0.5.0[#](#id29 "Link to this heading")
...
## 0.4.4[#](#id30 "Link to this heading")
...
## 0.4.3[#](#id31 "Link to this heading")
...
## 0.4.2[#](#id32 "Link to this heading")

* fix: loading configuration for trt\_profile from package
...
## 0.4.1[#](#id33 "Link to this heading")
...
* Version of external components used during testing:
  ...
  + [PyTorch 1.14.0a0+410ce96](https://github.com/pytorch/pytorch/commit/410ce96)
  + [TensorFlow 2.11.0](https://github.com/tensorflow/tensorflow/releases/tag/v2.11.0)
  + [TensorRT 8.5.2.2](https://docs.nvidia.com/deeplearning/tensorrt/release-notes/index.md)
  + [ONNX Runtime 1.13.1](https://github.com/microsoft/onnxruntime/tree/v1.13.1)
...
## 0.4.0[#](#id34 "Link to this heading")
...
## 0.3.8[#](#id35 "Link to this heading")
...
## 0.3.7[#](#id36 "Link to this heading")
...
## 0.3.6[#](#id37 "Link to this heading")
...
## 0.3.5[#](#id38 "Link to this heading")
...
* Model Navigator Export API:
  ...
  + fix: invalid use of Polygraphy TRT profile when trt\_dynamic\_axes is passed to export function
...
## 0.3.4[#](#id39 "Link to this heading")
...
* Model Navigator Export API:
  ...
  + new: TrtexecRunner for correctness and performance tests
    with [trtexec](https://docs.nvidia.com/deeplearning/tensorrt/developer-guide/index.md#trtexec) tool
  ...
  + new: Testing all options for JAX export enable\_xla and jit\_compile parameters
...
## 0.3.3[#](#id40 "Link to this heading")
...
## 0.3.2[#](#id41 "Link to this heading")
...
## 0.3.1[#](#id42 "Link to this heading")
...
* Model Navigator OTIS:
  ...
  + new: Added option `--model-config-name` to the `select` command.
    ...
    generated by Triton Model Analyzer, even if itâs not the best performing one.
...
## 0.3.0[#](#id43 "Link to this heading")
...
## 0.2.7[#](#id44 "Link to this heading")
...
## 0.2.6[#](#id45 "Link to this heading")
...
## 0.2.5[#](#id46 "Link to this heading")
...
## 0.2.4[#](#id47 "Link to this heading")
...
## 0.2.3[#](#id48 "Link to this heading")
...
## 0.2.2[#](#id49 "Link to this heading")
...
## 0.2.1[#](#id50 "Link to this heading")

* Fixed triton-model-config error when tensorrt\_capture\_cuda\_graph flag is not passed
...
## 0.2.0[#](#id51 "Link to this heading")
...
## 0.1.1[#](#id52 "Link to this heading")

* documentation update

## 0.1.0[#](#id53 "Link to this heading")
...
* Versions of used external components:
  ...
  + tf2onnx: [v1.8.4](https://github.com/onnx/tensorflow-onnx/releases/tag/v1.8.4) (support for ONNX opset 13, tf 1.15
    and 2.4)
  + Other component versions depend on the used framework and Triton Inference Server containers versions.
    Refer to its [support matrix](https://docs.nvidia.com/deeplearning/frameworks/support-matrix/index.md)
    for a detailed summary.
