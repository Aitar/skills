...
# Model Analyzer CLI[#](#model-analyzer-cli "Link to this heading")

Use the `-h` or `--help` flag to view a description of the Model Analyzerâs
...
## Model Analyzer Modes[#](#model-analyzer-modes "Link to this heading")
...
### Online Mode[#](#online-mode "Link to this heading")
...
See the example [online summary](https://github.com/triton-inference-server/model_analyzer/blob/main/examples/online_summary.pdf) and [online detailed report](https://github.com/triton-inference-server/model_analyzer/blob/main/examples/online_detailed_report.pdf).

### Offline Mode[#](#offline-mode "Link to this heading")
...
See the example [offline summary](https://github.com/triton-inference-server/model_analyzer/blob/main/examples/offline_summary.pdf) and
[offline detailed report](https://github.com/triton-inference-server/model_analyzer/blob/main/examples/offline_detailed_report.pdf) examples.

## Model Analyzer Subcommands[#](#model-analyzer-subcommands "Link to this heading")

The Model Analyzerâs functionality is split across three separate subcommands. Each
...
## Subcommand: `profile`[#](#subcommand-profile "Link to this heading")

The `profile` subcommand begins by loading the âlatestâ checkpoint (if available) in
...
parameters](config.md#model-config-parameters) (e.g. *max batch size*, *dynamic batching*, and *instance group count*), it will run tritonserver and perf analyzer instances with
...
## Subcommand: `report`[#](#subcommand-report "Link to this heading")
