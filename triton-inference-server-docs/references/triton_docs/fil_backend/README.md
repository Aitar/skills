...
# Triton Inference Server FIL Backend[#](#triton-inference-server-fil-backend "Link to this heading")
...
### Contributor Docs[#](#contributor-docs "Link to this heading")
...
## Not sure where to start?[#](#not-sure-where-to-start "Link to this heading")

If you arenât sure where to start with this documentation, consider one of the
following paths:
...
1. Check out the FIL backendâs [blog post announcement](https://developer.nvidia.com/blog/real-time-serving-for-xgboost-scikit-learn-randomforest-lightgbm-and-more/)
...
3. Review the FAQ notebookâs [tips](https://nbviewer.org/github/triton-inference-server/fil_backend/blob/main/notebooks/faq/FAQs.ipynb#Example-9:-Optimizing-model-performance) for optimizing model performance.
...
1. Take a look at XGBoostâs [documentation](https://xgboost.readthedocs.io/en/stable/get_started.md#python).
...
**I donât like reading docs.**

1. Look at the
   [Quickstart](#quickstart-deploying-a-tree-model-in-3-steps) below
...
## Quickstart: Deploying a tree model in 3 steps[#](#quickstart-deploying-a-tree-model-in-3-steps "Link to this heading")
