...
# C API Description[#](#c-api-description "Link to this heading")
...
## Versioning and Backwards Compatibility[#](#versioning-and-backwards-compatibility "Link to this heading")
...
### Non-Inference APIs[#](#non-inference-apis "Link to this heading")
...
### Inference APIs[#](#inference-apis "Link to this heading")
...
[grpc\_server.cc](https://github.com/triton-inference-server/server/blob/main/src/grpc/grpc_server.cc) and
[http\_server.cc](https://github.com/triton-inference-server/server/blob/main/src/http_server.cc).
