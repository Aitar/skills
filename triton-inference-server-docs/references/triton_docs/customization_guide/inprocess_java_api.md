...
# Java bindings for In-Process Triton Server API[#](#java-bindings-for-in-process-triton-server-api "Link to this heading")
...
and the bindings for `C-API Wrapper`. More information about the [developer\_tools/server C-API wrapper](https://github.com/triton-inference-server/developer_tools/blob/main/server/README.md) can be found in the [developer\_tools repository](https://github.com/triton-inference-server/developer_tools/).
...
In the [QA folder](https://github.com/triton-inference-server/server/blob/main/qa), folders starting with L0\_java include Java API tests.
...
## Java API setup instructions[#](#java-api-setup-instructions "Link to this heading")
...
### Run Tritonserver container and install dependencies[#](#run-tritonserver-container-and-install-dependencies "Link to this heading")
...
### Run Java program with Java bindings Jar[#](#run-java-program-with-java-bindings-jar "Link to this heading")
...
1. Place Java bindings into your environment. You can do this by either:
   ...
   *or*
   ...
   b. Copying âUber Jarâ from Triton SDK container to your environment
...
2. Use the built âUber Jarâ that contains the Java bindings

   ```
   $ java -cp <Uber Jar directory>/tritonserver-java-bindings.jar <your Java program>
   ```

#### Build Java bindings and run Java program with Maven[#](#build-java-bindings-and-run-java-program-with-maven "Link to this heading")
