...
* [KServe API](../client_guide/kserve.md)
* Inference...

# Inference Protocols and APIs[#](#inference-protocols-and-apis "Link to this heading")

Clients can communicate with Triton using either an [HTTP/REST
protocol](#http-rest-and-grpc-protocols), a [GRPC
protocol](#http-rest-and-grpc-protocols), or by an [in-process C
...
## HTTP/REST and GRPC Protocols[#](#http-rest-and-grpc-protocols "Link to this heading")
...
#### Mapping Triton Server Error Codes to HTTP Status Codes[#](#mapping-triton-server-error-codes-to-http-status-codes "Link to this heading")
...
For client-side documentation, see [Client-Side GRPC SSL/TLS](../client/README.md#ssl-tls)

For more details on overview of authentication in gRPC, refer [here](https://grpc.io/docs/guides/auth/).

#### Compression[#](#id1 "Link to this heading")
...
For client-side documentation, see [Client-Side GRPC Compression](../client/README.md#id2)

Compression can be used to reduce the amount of bandwidth used in server-client communication. For more details, see [gRPC Compression](https://grpc.github.io/grpc/core/md_doc_compression.md).
...
#### GRPC Inference Handler Threads[#](#grpc-inference-handler-threads "Link to this heading")
...
Note: More threads donât always mean better performance.

### Limit Endpoint Access (BETA)[#](#limit-endpoint-access-beta "Link to this heading")
